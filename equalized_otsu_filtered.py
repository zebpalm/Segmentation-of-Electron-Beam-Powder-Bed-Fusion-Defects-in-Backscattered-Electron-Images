...
def preprocess_image(image, kernel_size=(11,11), sigma=3.0):
    """
    ...
    num_labels, labels, stats, centroids = cv2.connectedComponentsWithStats(otsu_thresh, connectivity=4)
...
def main():
    ...
    output_dir = Path("/Users/zebpalm/Exjobb 2025/Coding/equalized_otsu_filtered")
